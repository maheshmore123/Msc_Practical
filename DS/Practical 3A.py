...
sInputFileName='C:/Data Science/Practical 3 A/Country_Code.csv' 
...
f=open('C:/Data Science/Practical 3 A/Country_Code_Log.txt',"a")
...
sOutputFileName='C:/Data Science/Practical 3 A/HORUS-CSV-Country.csv'
